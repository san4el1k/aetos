(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[36], {
    1036: function(e, t, n) {
        !function(e, t, n) {
            "use strict";
            function r(e) {
            ...
            var c = ["animationData", "loop", "autoplay", "initialSegment", "onComplete", "onLoopComplete", "onEnterFrame", "onSegmentStart", "onConfigReady", "onDataReady", "onDataFailed", "onLoadedImages", "onDOMLoaded", "onDestroy", "lottieRef", "renderer", "name", "assetsPath", "rendererSettings"]
              , f = function(e, t) {
                var r, a = e.animationData, f = e.loop, d = e.autoplay, m = e.initialSegment, p = e.onComplete, y = e.onLoopComplete, v = e.onEnterFrame, g = e.onSegmentStart, b = e.onConfigReady, S = e.onDataReady, h = e.onDataFailed, O = e.onLoadedImages, A = e.onDOMLoaded, w = e.onDestroy;
                e.lottieRef,
                e.renderer,
                e.name,
                e.assetsPath,
                ...
                var j = l(e, c)
                  , P = function(e) {
                    ...
                    if (null != n) {
                        ...
                        try {
                            for (i = (n = n.call(e)).next; !(l = (r = i.call(n)).done) && (u.push(r.value),
                            2 !== u.length); l = !0)
                                ;
                        } catch (e) {
                            s = !0,
                ...
                n.useEffect(function() {
                    if (R.current) {
                        ...
                        Array.isArray(m) && m.length && ((R.current.currentRawFrame < m[0] || R.current.currentRawFrame > m[1]) && (R.current.currentRawFrame = m[0]),
                ...
                n.useEffect(function() {
                    ...
                    if (s && r && i.length)
                        ...
                        case "scroll":
                            return e = null,
                            n = function() {
                                var t, n, o, a = (n = (t = s.getBoundingClientRect()).top,
                                o = t.height,
                                (window.innerHeight - n) / (window.innerHeight + o)), u = i.find(function(e) {
                                    var t = e.visibility;
                                ...
                                if (u) {
                                    ...
                                    "loop" === u.type && (null === e ? (r.playSegments(u.frames, !0),
                                    e = u.frames) : e !== u.frames ? (r.playSegments(u.frames, !0),
                            ...
                            return a = function(e, t) {
                                ...
                                if (d) {
                                    if ("seek" === d.type && d.position && Array.isArray(d.position.x) && Array.isArray(d.position.y) && 2 === d.frames.length) {
                                        ...
                                        r.goToAndStop(Math.ceil((m + p) / 2 * (d.frames[1] - d.frames[0])), !0)
                                    }
                                    "loop" === d.type && r.playSegments(d.frames, !0),
                                    "play" === d.type && (r.isPaused && r.resetSegments(!1),
            ...
            e.default = function(e) {
                var t, r, o, i = e.style, a = e.interactivity, u = f(l(e, p), i), s = u.View, c = u.play, d = u.stop, y = u.pause, v = u.setSpeed, g = u.goToAndStop, b = u.goToAndPlay, S = u.setDirection, h = u.playSegments, O = u.setSubframe, A = u.getDuration, w = u.destroy, j = u.animationContainerRef, P = u.animationLoaded, D = u.animationItem;
                return n.useEffect(function() {
